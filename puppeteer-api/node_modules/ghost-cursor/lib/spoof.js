    ...
    var actions = {
        ...
        click: function (selector, options) {
            return __awaiter(this, void 0, void 0, function () {
                var optionsResolved, wasRandom, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            optionsResolved = __assign(__assign({ moveDelay: 2000, hesitate: 0, waitForClick: 0, randomizeMoveDelay: true }, defaultOptions === null || defaultOptions === void 0 ? void 0 : defaultOptions.click), options);
                            wasRandom = !moving;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            go = function (iteration) { return __awaiter(_this, void 0, void 0, function () {
                                var elem, _a, handle, box, height, width, destination, dimensions, overshooting, to, correction, newBoundingBox;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                        ...
                                        case 13:
                                            _b.sent();
                                            if (!overshooting) return [3 /*break*/, 15];
                                        ...
                                        case 16:
                                            newBoundingBox = _b.sent();
                                            if (!!intersectsElement(to, newBoundingBox)) return [3 /*break*/, 18];
        ...
        scrollIntoView: function (elem, options) {
            return __awaiter(this, void 0, void 0, function () {
                var optionsResolved, _a, viewportWidth, viewportHeight, docHeight, docWidth, scrollPositionTop, scrollPositionLeft, elemBoundingBox, elemBox, marginedBox, marginedBoxRelativeToDoc, targetBox, top, left, bottom, right, isInViewport, scrollSpeed, cdpClient_1, manuallyScroll, objectId, _b, e_3;
                var _this = this;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            optionsResolved = __assign({ scrollSpeed: 100, scrollDelay: 200, inViewportMargin: 0 }, options);
                        ...
                        case 3:
                            ...
                            cdpClient_1 = getCDPClient(page);
                            manuallyScroll = function () { return __awaiter(_this, void 0, void 0, function () {
                                var deltaY, deltaX, xDirection, yDirection, largerDistanceDir, _a, largerDistance, shorterDistance, EXP_SCALE_START, largerDistanceScrollStep, numSteps, largerDistanceRemainder, shorterDistanceScrollStep, shorterDistanceRemainder, i, longerDistanceDelta, shorterDistanceDelta, _b, deltaX_1, deltaY_1;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            deltaY = 0;
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, cdpClient_1.send('Input.dispatchMouseEvent', {
                                                    type: 'mouseWheel',
                                                    deltaX: deltaX_1,
                                                    deltaY: deltaY_1,
                                                    x: 0,
                            ...
                            if (!(scrollSpeed === 100 && optionsResolved.inViewportMargin <= 0)) return [3 /*break*/, 9];
                            _c.label = 4;
                        case 4:
                            _c.trys.push([4, 6, , 8]);
                            ...
                            if (objectId === undefined)
                                throw new Error();
                            return [4 /*yield*/, cdpClient_1.send('DOM.scrollIntoViewIfNeeded', { objectId: objectId })];
                        case 5:
                            _c.sent();
                            return [3 /*break*/, 8];
                        case 6:
                        ...
                        case 9: return [4 /*yield*/, manuallyScroll()];
                        case 10:
                            _c.sent();
                            _c.label = 11;
                        case 11: return [3 /*break*/, 14];
                        ...
                        case 13:
                            _c.sent();
                            return [3 /*break*/, 14];
                        case 14: return [4 /*yield*/, delay(optionsResolved.scrollDelay)];
                        case 15:
                            _c.sent();
                            return [2 /*return*/];
                    }
